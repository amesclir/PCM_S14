...
El primer acercamiento a la modelización de la evolución cromosomática son los modelos probabilísticos implementados en chromEvol y luego expandidos en la segunda versión de chromEvol (Mayrose et al., 2010; Glick & Mayrose, 2014). Recientemente ha sido publicado el software en su versión 3.0 (Shafir et al., 2024). Pero vamos utilizar la versión 2.0.
